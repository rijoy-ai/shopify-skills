...
Eval results live in a **sibling workspace**: `high-visual-arvr-immersive-marketing-rijoy-workspace/`, organized by iteration and eval name. Run/grade/aggregate/viewer steps follow the [skill-creator](https://github.com/anthropics/skills) workflow—see `evals/README.md`.
...
- **Run evals**: Use skill-creator’s with-skill vs baseline flow; put outputs in `high-visual-arvr-immersive-marketing-rijoy-workspace/iteration-N/<eval_name>/`.
